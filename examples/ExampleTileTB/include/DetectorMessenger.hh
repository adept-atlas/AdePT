...
private:
  ...
  /// Command to set the directory for detector settings /exampleTileTB/detector
  G4UIdirectory *fDetectorDir = nullptr;
  /// Command to set the directory for AdePT integration settings /exampleTileTB/adept
