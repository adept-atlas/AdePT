...
// ********************************************************************
//
#ifndef EMSHOWERMESSENGER_HH
#define EMSHOWERMESSENGER_HH
 ...
 *
 * Allows to set the parameters of the EMShowerModel: parameters of the
...
class EMShowerMessenger : public G4UImessenger {
public:
  EMShowerMessenger(EMShowerModel *aModel);
  ~EMShowerMessenger();
...
private:
  /// Model to setup
  EMShowerModel *fModel;
  /// Command to set the up a directory for model settings /exampleTileTB/fastSim
