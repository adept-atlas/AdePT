...
{
  fGunDir = new G4UIdirectory("/exampleTileTB/gun/");
  fGunDir->SetGuidance("gun control");

  fHepmcCmd = new G4UIcmdWithoutParameter("/exampleTileTB/gun/hepmc", this);
  fHepmcCmd->SetGuidance("select hepmc input");
  fHepmcCmd->AvailableForStates(G4State_PreInit, G4State_Idle);


  fDefaultCmd = new G4UIcmdWithoutParameter("/exampleTileTB/gun/setDefault", this);
  ...
  fPrintCmd = new G4UIcmdWithoutParameter("/exampleTileTB/gun/print", this);
  fPrintCmd->SetGuidance("print gun kinematics in PrimaryGenerator");
  fPrintCmd->AvailableForStates(G4State_PreInit, G4State_Idle);

  fRndmCmd = new G4UIcmdWithADouble("/exampleTileTB/gun/rndm", this);
  ...
  fRndmDirCmd = new G4UIcmdWithADouble("/exampleTileTB/gun/rndmDir", this);
